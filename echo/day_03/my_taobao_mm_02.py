...
class Spider:
    ...
    def savePagesInfo(self, pageIndex):
        ...
        for item in contents:
            ...
            imageNumber = re.findall(r"<span .*?>\d+</span>", albumReponseString, re.I|re.S|re.M)
            # print(mmAlbums)
            ...
            for item in mmAlbums:
                ...
                albumPath = "taobao_2/" + mm_name + "/" + albumName
                ...
                pageNumber = int(imageNumber[0]) / 15

                for i in range(1, pageNumber):
                    #某个相册的地址
                    mm_link = "https://mm.taobao.com/album/json/get_album_photo_list.htm?user_id=" + parms["user_id"][0] + "&album_id=" + parms["album_id"][0] + "&top_pic_id=0&cover=%2F%2Fimg.alicdn.com%2Fimgextra%2Fi1%2F687471686%2FTB1jlwCHXXXXXcvXXXXXXXXXXXX_!!687471686-0-tstar.jpg&page=" + str(i) + "&_ksTS=1502652171209_154&callback=jsonp15"
